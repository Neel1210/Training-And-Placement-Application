...
public class HrSetQuizFrame extends javax.swing.JFrame {
    ...
    void insertData()
    {
        try
        {
            ...
            ResultSet rs=JobDao.getAllPendingJobByCompanyName(companyName);
            int flag=0;
            ...
            if(flag==0)
            {
                JOptionPane.showMessageDialog(null,"No Pending quiz ...\nall completed !!!","SomeThing Went Wrong ",JOptionPane.WARNING_MESSAGE);
            }
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(setQuizBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 670, 250, 30));
        ...
        nameLbl1.setText("All jobs with status \"0\" -");
        jPanel1.add(nameLbl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 360, 210, 30));
    ...
    private void setQuizBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setQuizBtnActionPerformed
        ...
        if(row!=-1)
        {
            ...
            new HrSetQuizFrame1(jobId).setVisible(true);
            this.dispose();
        }
        else
        {
