 ...
 * @author Neel_Esh
 */
public class PtAllCompletedJobFrame extends javax.swing.JFrame {

    /**
     * Creates new form PtAllCompletedJobFrame
     */
    DefaultTableModel model;
    public PtAllCompletedJobFrame() {
    ...
    void insertData()
    {
        try
        {
            ...
            int ii=0, jj=0;
            ResultSet rs=ResultsDao.getAllCompletedJob(resultPojo);
            while(rs.next())
            {
                ...
                {   ii++;
                    ...
                    for(int j=0;j<5;j++)
                    {
                        ...
                        if(j==4)
                        {
                           int per=ResultsDao.getPercent(CurrentUser.id,(String)allJobTbl.getValueAt(i,0));
                           allJobTbl.setValueAt(per+"%",i,j);
    ...
    private void initComponents() {
        ...
        allJobTbl.setRowSelectionAllowed(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PtAllCompletedJobFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
