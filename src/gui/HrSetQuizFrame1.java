 ...
 * @author Neel_Esh
 */
public class HrSetQuizFrame1 extends javax.swing.JFrame {
    ...
    public HrSetQuizFrame1(String jobId) {
        ...
        if(counter>0)
        {
            if(validateInput())
            {
               ...
               {  
                    ...
                    QuestionPojo que=setDataInObj();
                    
                    if(setData(counter)==1)
                    {
                        list.add(counter,que);
                        total = total+1;
                    }   
                    else
                    {
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtnActionPerformed
        ...
        if(validateInput())
        {
            ...
            {   
                ...
                if(QuestionsDao.setPaper(list))
                {
                    JobDao.setJobStatus(jobId);
                    JOptionPane.showMessageDialog(null,"Paper Added sucessfully","Success",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HrSetQuizFrame1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HrSetQuizFrame1().setVisible(true);
            }
        });
    }
