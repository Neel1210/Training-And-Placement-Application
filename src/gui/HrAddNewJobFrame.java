...
public class HrAddNewJobFrame extends javax.swing.JFrame {
    ...
    private void reloadData()     
    {
         try
        {
            jobIdLbl.setText("Job-"+JobDao.getJobId());
            companyNameTxt.setText(HrDao.getCompanyNameById(CurrentUser.id));
        }
    ...
    private void addJobBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJobBtnActionPerformed
        ...
        if(validateInputs())
        {
            ...
            job.setHrId(CurrentUser.id.trim());
